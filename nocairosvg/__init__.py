...
Optional[int]] = (None, None)) -> Image.Image:
	...
	await page.evaluate("convert('{width}', '{height}', 'rgb{backgroundColour}', '{url}')"
	.format(width=width, height=height, backgroundColour=backgroundColour, url=url)) # yapf: disable
